...
def load_cli_args(io_args: List[str]) -> tuple[List[int], int]:
    """
    load_cli_args function to load I/O args from the command line and map them to
    the expected output, that output is a tuple with a List of integers and an integer.
    Params:
    ...
    """
    # split the io_args list in two strings
